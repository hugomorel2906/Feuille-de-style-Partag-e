  ...
  <!-- fin header-->
    ...
    <section class="container-fluid">
      ...
      <p style="text-align:right"><a href="" >Besoin d'aide pour estimer les quantités ?</a></p> <!-- lien à ajouter une fois al base de données créée-->
          <br>
      <div class="alert alert-danger" role="alert" id="" value=""> <!-- faire apparaître si tout bon -->
	...
	?>
      ...
      <div class="row vertical-align-center">
        ...
        <div class="col-3 text-center">
          ...
          <p><br></p><nav class="boutons" onclick=>
            <!-- Je ne sais pas si nécessaire pour mémoriser l'élément séléctionner dans la listé précedente -->
			
			
			<button type="submit" class="btn btn-lg text-center btn-custom-valider" name="bt_valider_alim" value=""> Valider </button>
		</FORM>
        ...
        <nav class="boutons text-center">
          <button type="button" class="btn btn-lg text-center btn-custom" value=""> <a href="./menu-saisies-donnees.php"> Retour</a></button>
          <button type="button" class="btn btn-lg text-center btn-custom" value=""> <a href="./page-accueil.php">Accueil </a></button>
        </nav>
        <p><br></p>
      ...
      <div class="row navbar container-fluid" style="background-color:#F2B705">
        <div class="row">
