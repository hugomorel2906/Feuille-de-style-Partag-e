    ...
    <div class="container-fluid">
      ...
      <div class="card card-custom-text py-2">
        <div class="d-md-block text-center">
          <?php
            if(isset($_GET["bouton1"])){ // Si on a déja séléctionné une question on affiche cette boucle if
              $val=$_GET["bouton1"];
          ...
          <form action="gestion_td.php" method="GET">
            ...
            <div class="row mb-2 g-3 align-items-center">
              ...
              <div class="col-md-5 d-inline-flex">
                ...
                <!-- Formulaire d'ajout -->
                    <?php if(isset($_GET["bt_ajouter_categorie"])){ ?>
            ...
            <!-- TYPE DE QUESTION -->
              <div class="row g-3 align-items-center">
                ...
                <div class="col-md-4 d-inline-flex">
                  ...
                  <?php echo '<input type="hidden" name="bouton1" value="'.$_GET['bouton1'].'">' ?>
