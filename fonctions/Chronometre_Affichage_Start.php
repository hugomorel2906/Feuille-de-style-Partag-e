...
<?php
//Nils Hocquemiller
//Affichage d'un chronomètre et start
...
//Ici, le code n'utilise que la fonction Start, d'autre pages similaires à celle-ci permettront de stopper le chrono
...
<!-- Le body va directement executé la fonction Start_chrono qui se trouve ds le fichier javascript -->
<body onload='Start_chrono()'>
